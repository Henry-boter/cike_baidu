<template>
    <div class="cike-baidu">
      ...
      <div class="banner" @click="play2">
        <!--点击播放-->
        <img src="../assets/images/travel/travel-banner.jpg" width="100%" onclick="return false"/>
      </div>
      <!--头部banner-->
      <div class="welcome">
      ...
      <div class="online_class">
        <img src="../assets/images/travel/travel-1.jpg" width="100%" onclick="return false"/>
        <img src="../assets/images/travel/travel-video.png"  id="online_class" width="90%" style="margin: 5%" @click="isClassList=true" onclick="return false"/>
      </div>
      ...
      <div v-transfer-dom>
        <popup v-model="isShowYuyue" position="bottom" max-height="100%">
          ...
          <div class="popup-content">
            ...
            <div class="come-school">
              <group gutter="0">
                <x-input v-model="phoneComeSchool" type="tel" novalidate :icon-type="iconTypeComeSchool" :show-clear="false" :max="11" placeholder="电话">
                  <img slot="label" class="input-icon" src="../assets/images/baiduImg/mobilephone.png" onclick="return false"/>
                </x-input>
              </group>
            </div>
      ...
      <div v-transfer-dom>
        <popup v-model="isShowOffer" position="bottom" max-height="100%">
          ...
          <div class="popup-content">
            ...
            <group>
              <x-input v-model="phonePlan" type="tel" is-type="china-mobile" placeholder="电话">
                <img slot="label" class="input-icon" src="../assets/images/baiduImg/mobilephone.png" onclick="return false"/>
              </x-input>
